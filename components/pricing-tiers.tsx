...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    points: ["One-time payment per lab", "3 launches within 7 days", "Every level — one flat price", "Great for targeted practice"],
  ...
  },
  {
    ...
    points: ["All AWS labs included", "New labs as we ship them", "Launch any lab (fair use: 8/day)", "Cancel anytime"],
