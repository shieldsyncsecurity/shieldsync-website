...
export const FAQS: Record<string, { q: string; a: string }[]> = {
  ...
  labs: [
    { q: "What do I need to start a lab?", a: "Just a browser. Labs run in managed environments — no AWS account or local setup needed." },
    { q: "Are AWS labs the main focus?", a: "Yes — AWS cloud security is our flagship, with SIEM and SOAR completing a full SOC skill set." },
    { q: "Can teams use the labs?", a: "Yes — labs are available to individual learners and to teams as labs-as-a-service." },
  ],
};
