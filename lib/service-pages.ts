...
export const SERVICE_PAGES: ServicePage[] = [
  {
    ...
    metaDescription: "AWS security assessment and hardening — IAM, S3, encryption, VPC, GuardDuty — plus Azure, GCP, and on-prem. Practitioner-led, fix-first remediation.",
  },
  {
